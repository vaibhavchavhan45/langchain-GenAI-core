...
template4 = PromptTemplate(
    template = 'Using this post copy data: {input} \n\nCreate appropriate hashtags for Instagram \n {format_instruction}',
    input_variables = ['input'],
...
result = chain.invoke({
    ...
    'product_description': 'A new gen smartwatch which supports voice calling and heart beat measurement also identifies Blood Pressure',
    'platform': 'Instagram'
})
